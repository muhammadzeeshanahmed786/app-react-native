...
import { View, Text, Image, StyleSheet, TextInput, TouchableOpacity,Badge } from 'react-native';
...
function MainScreen({ navigation }) {
    ...
    // let quantity=state.cartItem.length;
                ...
                <Stack.Screen
                    ...
                    options={{
                        ...
                        headerRight: () => (
                            ...
                            <Text style={{ position: 'absolute', top: 4, right: 4,backgroundColor:'#900',textAlign:'center',color:'#fff',borderRadius:20,height:20,width:20 }}>{state.cartItem.length}</Text>
